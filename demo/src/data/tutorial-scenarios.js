  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        narration: 'AP has $1.19M queued — marketer commissions and the AltaGas settlement. The first AP item is being approved now. Watch what happens: journal entry created automatically, no manual GL entry, no email to accounting.',
      },
      {
      ...
      },
      {
        ...
        narration: 'The governance panel is what prevents regression. New GL codes require Finance Manager approval. Cost centre justification is mandatory. Sunset dates are enforced on project codes. This is the part most teams skip — and why they end up back in the same place three years later.',
      },
    ],
  },
  {
