...
export const CACHE = {
  ...
  <div style="font:400 12px var(--font-ui);color:var(--text);line-height:1.7">Dear Valued Customer,<br><br>We're writing regarding your outstanding balance on your account. Your payment is past due and we'd like to work with you to resolve this before escalation.<br><br><strong>Next steps:</strong> Please contact us within 7 days to arrange payment or discuss a payment plan. We offer flexible options for accounts in good standing. If we don't hear from you, your account may be referred to collections per our terms of service.<br><br>the company Billing Operations</div>
...
export function getCacheKey(text, context = '') {
  ...
  const patterns = [
    ...(isMacGregor ? [
      ['summarize macgregor recent issues', ['summarize this customer', 'recent issues macgregor', 'account summary macgregor', 'what happened macgregor', 'history macgregor']],
      ['draft macgregor response', ['draft macgregor email', 'response to macgregor', 'email to sarah mitchell', 'write macgregor', 'draft response for macgregor']],
    ] : []),
    ['summarize customer issues', ['summarize this customer', 'recent issues this account', 'account summary', 'what happened with this customer', 'customer history']],
    ['draft response altagas', ['draft altagas', 'response to altagas', 'altagas dispute letter', 'altagas response']],
    ['draft customer email', ['draft customer email', 'write customer email', 'draft response explaining', 'explaining last invoice', 'draft a response to']],
    ['create follow-up task', ['create follow-up task', 'create followup task', 'create a task', 'update case status', 'apply and update case']],
    ['explain billing exception', ['explain exc-0311', 'explain this exception', 'why was this exception flagged', 'root cause of exception', 'what caused this exception']],
    ['ap items blocking month end', ['ap items blocking', 'blocking month-end close', 'month end close blockers', 'what is blocking month end']],
    ['what changed since last bill', ['what changed since last bill', 'changed since last invoice', 'vs last bill', 'previous bill comparison']],
    ['recommend next step exception', ['recommend next step', 'how to resolve this exception', 'resolution for this exception']],
    ['root cause settlement', ['root cause of this settlement', 'settlement mismatch root cause', 'why is there a variance', 'what caused the settlement mismatch']],
    ['what to resolve before closing', ['what needs to be resolved before closing', 'resolve before close', 'settlement close checklist']],
    ['top revenue risks q2', ['top revenue risks', 'q2 revenue risk', 'biggest revenue risk', 'business risks this quarter']],
    ['which accounts prioritize', ['which accounts to prioritize', 'prioritize these accounts', 'who are the 17 accounts', 'priority account list']],
    ['30 day action plan', ['30 day action plan', '30-day plan', 'action plan for next 30 days']],
    ['reduce late payments', ['reduce late payments', 'late payment risk reduction', 'collections strategy', 'how to reduce payment risk']],
    ['draft collections email', ['draft collections email', 'collections outreach email', 'write outreach for top 5', 'draft email for at-risk accounts']],
    ['forecast april revenue', ['forecast april revenue', 'april revenue forecast', 'next month revenue forecast']],
    ['marketers below target', ['marketers below target', 'underperforming marketers', 'marketer performance issues', 'which marketers are trending below']],
    ['which marketers need attention', ['which marketers need attention', 'marketers needing attention this month']],
    ['forecast service call volume', ['forecast service call volume', 'service call forecast', 'predicted call volume']],
    ['top drivers billing exceptions', ['top drivers of billing exceptions', 'billing exception drivers', 'what is causing exceptions this month']],
  ];
